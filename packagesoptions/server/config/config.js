...
const getConfig = () => {
  if(process.env.IS_LOCAL_DEVELOPMENT === 'true') {
    ...
    return {
      ...
      COSMOSDB_DATABASE_ALGO_CONTENT: process.env.COSMOSDB_DATABASE_ALGO_CONTENT,
      COSMOSDB_COLLECTION_ALGO_CONTENT_VEHICLE: process.env.COSMOSDB_COLLECTION_ALGO_CONTENT_VEHICLE
    }
  }
}
